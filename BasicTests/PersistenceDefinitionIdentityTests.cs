...
namespace BasicTests
{
    ...
    public class WFApplicationPersistenceDefinitionIdentityTests
    {
        public WFApplicationPersistenceDefinitionIdentityTests()
        {
        ...
        public void TestPersistenceWithDelayAndResult()
        {
            ...
            var definitionIdentity = new WorkflowIdentity("Cal", new Version(2, 0), null);
            ...
            stopwatch.Restart();
            var t = WFDefinitionIdentityStore.Instance.TryAdd(definitionIdentity, a);
            stopwatch.Stop();
